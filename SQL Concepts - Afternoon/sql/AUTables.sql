...
ALTER TABLE SALES_EXE ADD FOREIGN KEY (LOC_CODE) REFERENCES LOCATION(LOC_CODE);

ALTER TABLE SALE ADD FOREIGN KEY (SE_ID) REFERENCES SALES_EXE(SE_ID);
ALTER TABLE SALE ADD FOREIGN KEY (CUST_ID) REFERENCES CUSTOMER(CUST_ID);

ALTER TABLE SALE_PRODUCT ADD FOREIGN KEY (SE_ID) REFERENCES SALES_EXE(SE_ID);
ALTER TABLE SALE_PRODUCT ADD FOREIGN KEY (PROD_CODE) REFERENCES PRODUCT(PROD_CODE);